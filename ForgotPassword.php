	...
	<div class="card o-hidden border-0 shadow-lg my-5">
		<div class="card-body p-0">
			<div class="row">
				<div class="col-lg-6">
					<div class="p-5">
						<!--FORM KISMI BAŞLANGIÇ-->
						<div class="text-center">
							<h1 class="h4 text-gray-900 mb-4">Şifremi Unuttum</h1>
						</div>
						<form class="user" action="index.php?RC=6" method="post">
							<div class="form-group">
								<input type="email" class="form-control form-control-user" name="EmailAdresi" placeholder="Lütfen Email Adresinizi Giriniz.">
							</div>
